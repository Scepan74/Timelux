...
export interface ApiWatchWatch extends Schema.CollectionType {
  ...
  attributes: {
    ...
    gender: Attribute.Enumeration<['gents', 'ladies', 'unisex']>;
    movement: Attribute.Enumeration<['manual', 'automatic', 'quartz']>;
